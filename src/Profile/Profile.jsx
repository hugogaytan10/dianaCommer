...
export const Profile = () => {
  ...
  return (
    <div className="w-full flex flex-wrap flex-col justify-start items-center  min-h-screen bg-gray-100">
        ...
        <div className="bg-white p-2 w-3/4 h-40 mt-4 rounded-lg">
            <h3 className="text-gray-700 font-semibold mb-4">Ajustes</h3>
            <NavLink className="border-b-2 p-3 flex justify-between" to={'/direcciones'}>
              <p className="text-gray-500">Mis Direcciones</p>
              <p className="text-gray-500">{`>`}</p>
            </NavLink>
            <NavLink className="border-b-2 p-3 flex justify-between" to={'/listaDeseos'}>
        ...
        <div className="bg-white p-2 w-3/4 h-32 mt-4 rounded-lg">
            ...
            <NavLink className="border-b-2 p-3 flex justify-between" to={'/politica'}>
